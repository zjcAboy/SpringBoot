package com.example.chapter53.Controller;

import com.example.chapter53.Bean.Book;
import com.example.chapter53.Service.BookService;
...
public class BookController {
    ...
    @GetMapping("/findAll")
    public void findAll(){
        PageRequest pageable = PageRequest.of(2,3);//page从第0页开始
        Page<Book> page = bookService.getBookByPage(pageable);
        System.out.println("总页数:"+page.getTotalPages());
        System.out.println("总记录数:"+page.getTotalElements());
        System.out.println("查询结果:"+page.getContent());
        System.out.println("当前页数:"+(page.getNumber()+1));//当前页数如果不加一返回第0页
